...
> Design notes for **python-creator-image-delivery** — a runnable python example that Python upload workflow that resizes creator images and stores delivery copies.
...
- **Feature code** — the actual task: creator-image-upload.
